# Content Hub - Focal point cropping v3.4.1
...
Change log:
* v3.4.1 (Mar 3, 2025) has the following new feature:
  ...
  - Updated node dependencies, solved vulnerabilities, and added workaround to solve issue #26
